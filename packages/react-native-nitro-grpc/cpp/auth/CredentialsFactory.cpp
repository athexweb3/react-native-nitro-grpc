...
std::shared_ptr<::grpc::ChannelCredentials> CredentialsFactory::createChannelCredentials(const JsonParser::Credentials& creds) {
...
std::shared_ptr<::grpc::ChannelCredentials> CredentialsFactory::createComposite(const JsonParser::Credentials& channelCreds,
...
std::shared_ptr<::grpc::CallCredentials> CredentialsFactory::createBearerToken(std::function<std::string()> tokenProvider) {
...
// Custom metadata
std::shared_ptr<::grpc::CallCredentials> CredentialsFactory::createCustomMetadata(const std::map<std::string, std::string>& metadata) {
